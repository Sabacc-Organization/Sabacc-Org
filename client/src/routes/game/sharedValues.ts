...
export const SHIFT_TOKEN_DESCRIPTIONS: {[id: string]: string} = {
  ...
  "embezzlement": "embezzlement:<br>takes one chip from each of your opponents pots and puts them into your pot.",
  "majorFraud": "major fraud:<br>sets the imposter card value to six (as opposed to rolling the dice for it).",
  "generalTariff": "general tariff:<br>each opponent player permanently loses one chip from their pot.",
  "targetTariff": "target tariff:<br>choose one opponent player. they will permanently lose two chips from their pot.",
  "generalAudit": "general audit:<br>each opponent player in stand will permanently lose two chips from their pot.",
  "targetAudit": "target audit:<br>choose one opponent player in stand. they will permanently lose three chips from their pot. if you choose a player not in stand, you will get to choose again.",
